...
public class Ball 
{
	...
	private double xMovement;			// The X movement of this Ball
	private double yMovement;           // the Y movement of this Ball
	...
	/**
	 * Sets movement of ball in x direction
	 * @param X Speed of the ball in x direction
	 */
	...
	/**
	 * Sets movement of the ball in y direction
	 * @param Y Speed of the ball in y direction
	 */
	...
	/**
	 * Obtains the speed of the ball in x direction
	 * @return Speed of the ball in x direction
	 */
	public double getxMovement()
{
	...
	/**
	 * Obtains speed of the ball in y direction
	 * @return Speed of the ball in y direction
	 */
